...
<body>
    ...
    <div id="all">
        <div id="content">
            <div id="content-left">
                <div id="leftbar-menuname">자격증.확인서</div>

                <div class="descript" style="color: white; background-color: rgb(137, 137, 137);">
                    <div class="descript-main1" >확인서발급안내</div>
                </div>
                <div class="descript-menu" style="display: block;">
                    <li><a href="#" class="descript-menu-a" data-main="descript-main1" style="color: skyblue;">확인서발급안내</a></li>
                    <li><a href="#" class="descript-menu-a" data-main="descript-main1">확인서발급 신청</a></li>
                    <li><a href="#" class="descript-menu-a" data-main="descript-main1">확인서발급 신청내역 조회</a></li>
                </div>

                <div class="descript">
                    <div class="descript-main2">확인서진위확인</div>
                </div>
                <div class="descript-menu">
                    <li><a href="#" class="descript-menu-a" data-main="descript-main2">확인서진위확인</a></li>
                </div>
